...
#Set up runs
#In this example, to save time, we're only going to run for 2 scenarios and the median value
run_scenario <- ETH_projection_run_setup(location_characteristics = MAP_intervention_values[c(1, nrow(MAP_intervention_values)), ],
